...
with DAG(
    ...
    schedule=None,
    params={
        # Optional override; Variable UNIFIED_DATASET_ID is preferred
        "dataset_id": "",
        # HDF5 demo toggle
        "do_small_hdf5": True,
    },
    ...
    small_hdf5 = PythonOperator(
        task_id="transpose_small_hdf5",
        python_callable=transpose_small_hdf5,
    )
    ...
    fetch_data >> resolve >> run_cpptraj >> small_hdf5 >> summarize
